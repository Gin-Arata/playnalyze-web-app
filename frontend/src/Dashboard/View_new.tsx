...
<div className="position-relative w-100">
<form onSubmit={submitGameSearch}>
<input
type="search"
name="search"
className="form-control pe-5"
...
<strong>Recommendation:</strong> {game.recommendation_percent}%
</p>
<a href="#" className="btn btn-primary mt-auto" style={{ width: 'fit-content' }}>
View Details
</a>
</div>
</div>
